...
/// rendered from a positional rainbow palette (<see cref="MTGPlexer.Colors.ColorKnobs"/> /
/// <see cref="MTGPlexer.Colors.HexPalette"/>) — currently the type-expressions page's regex
...
public static class HoverTreatmentConfig
{
    ...
    /// <see cref="MTGPlexer.Colors.ColorKnobDefaults"/> and
    /// <see cref="MTGPlexer.Colors.DeterministicPalette"/> respectively for how those colors
