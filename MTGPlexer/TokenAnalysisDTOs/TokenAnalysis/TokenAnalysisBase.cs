...
/// </summary>
public abstract record TokenAnalysisBase
{
    ...
    public IReadOnlyList<TokenAnalysisBase> Children { get; init; } = [];
    ...
    protected string GetNestedCaptureString()
    {
        ...
        foreach (var child in Children.OrderByDescending(c => c.Start))
        {
            ...
            if (child is TokenAnalysisBranch branch && branch.IsCollapsed)
            {
