...
public class CardDataGetter
{
    ...
    public async Task<List<Card>> GetCardsAsync()
    {
        ...
        result = new List<Card> { new Card { Name = "Type1", Text = "creature has flying, reach, haste, and trample" }, new Card { Name = "Type2", Text = "creature has flying, reach, and trample" } };
