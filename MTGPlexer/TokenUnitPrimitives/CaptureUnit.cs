...
/// <summary>
/// Base for everything a tokenizer can produce for a span of source text: <see cref="TokenUnit"/>s,
/// which captured a recognized construct and its property graph, and
/// <see cref="TokenUnits.UnmatchedString"/>, which captured nothing and exists only to fill the
/// gaps between recognized constructs. Code that analyzes recognized constructs (e.g. TypeRegexPage)
/// should target <see cref="TokenUnit"/> directly - filtering a CaptureUnit sequence with
/// OfType&lt;TokenUnit&gt;() excludes unmatched spans without needing to special-case the type.
/// </summary>
