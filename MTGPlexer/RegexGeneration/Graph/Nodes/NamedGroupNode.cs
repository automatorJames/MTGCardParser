...
public abstract class NamedGroupNode : GroupNode
{
    ...
    protected RegexBrickGroupClose GetGroupCloseBrick() =>
        new(parentNode: this, quantifier: Navigation.IsOptional ? MTGPlexer.Quantifier.Optional : Quantifier);
    ...
    /// per declared/default pattern; subclasses that reflect over a type's properties (e.g. <see cref="TokenUnitNode"/>, <see cref="EnumNode"/>) override this instead.
    /// </summary>
