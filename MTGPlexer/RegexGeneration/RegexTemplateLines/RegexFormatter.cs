...
public class RegexFormatter
{
    ...
    void ExpandAlternateEnumContainer(
    ...
    void RenderBookendComment(EncloureBookend line, List<RegexCommentedLineSpan> spans, BoxCharSet chars, HexPalette borderPal, int width)
    {
