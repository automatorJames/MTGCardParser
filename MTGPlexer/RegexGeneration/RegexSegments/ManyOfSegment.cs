...
public record ManyOfSegment : XOfSegmentBase
{
    ...
    //            continue;
    //
    //        MatchTraversalState sectionGroupState = new(null, parentTokenUnitMatch, manyItemOrdinal.ToString());
    //
    //        var ordinalProp = TemplatePropInfo.DeriveForXOfItem(manyItemOrdinal.ToString());
    //
    //        // "first" will always have 1 item
    //        // "second" will have any number of items (including 0)
    //        // "last" will always have 1 item
    ...
    //        {
    //            var ordinalCapture = sectionGroupCaptures[j];
    //            //MatchTraversalState state = new(GenericType, sectionGroupState, null, i);
    //            MatchTraversalState state = new(GenericType, parentTokenUnitMatch, manyItemOrdinal.ToString(), i);
