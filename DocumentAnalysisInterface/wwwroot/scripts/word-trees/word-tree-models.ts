...
export interface AnalyzedSpan {
    ...
    documentPalettes: { [documentName: string]: DeterministicPalette };
 ...
 */
export interface ProcessedAnalyzedSpan extends Omit<AnalyzedSpan, 'documentPalettes'> {
    documentPalettes: Map<string, DeterministicPalette>;
