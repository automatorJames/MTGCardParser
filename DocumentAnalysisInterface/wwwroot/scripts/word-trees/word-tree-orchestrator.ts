 ...
 */
function createSvgDefs(svg: SVGSVGElement): SVGDefsElement {
...
export function orchestrateWordTreeRender(container: HTMLElement): void {
    ...
    const ctx: RenderContext = { svg, defs, config, containerId: container.id, data: processedData };
    ...
    const anchor = { id: 'main-anchor', text, spanGlyphTypes: null, layout: { x: 0, y: 0 } } as AnchorNode;
