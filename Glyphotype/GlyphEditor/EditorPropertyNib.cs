...
public record EditorPropertyNib : EditorBlockNib
{
    ...
    public EditorPropertyNib(Type basePropertyType, XOfType xOfType, string id, Proptions proptions = Proptions.None)
        : base(
    ...
    public EditorPropertyNib ConvertToXOfType(XOfType xOfType)
    {
        if (xOfType == XOfType)
            return this;
    ...
    public EditorPropertyNib UpdateProptions(Proptions oneHotToggleProptions)
    {
