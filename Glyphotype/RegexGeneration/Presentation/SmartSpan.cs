...
public record SmartSpan
{
    ...
    /// <summary>
    /// This span's rendering role, if it has one tagged (see <see cref="RegexSpanKind"/>) — null for
    ...
    /// </summary>
    public RegexSpanKind? Kind { get; }

    public SmartSpan(string content, string fullyQualifiedName, SpanStylePalette palette, RegexSpanKind? kind = null)
    {
        Content = content;
